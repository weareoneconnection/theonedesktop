...
Updates are served from GitHub Releases of `weareoneconnection/theone-releases`
(a public repository that holds only release files). macOS installs an update
...
4. Create the public repository `weareoneconnection/theone-releases`.
5. A GitHub token that can create releases there: `GH_TOKEN`.
